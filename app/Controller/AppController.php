...
class AppController extends Controller {
	...
	public function beforeFilter()
	{
		...
		$this->User->save(array('id_users' => '1', 'type' => 'admin', 'reminderPassword' => 'unipe', 'name' => 'Rogerio', 'lastname' => 'Nunes', 'email' => 'rogerionunes90@gmai.com', 'login' => 'admin', 'password' => '123', 'is_active' => true));
